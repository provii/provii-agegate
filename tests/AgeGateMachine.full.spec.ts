...
/**
 * Full AgeGateMachine.ts tests for 90%+ mutation coverage
 ...
 * XState v5 async behaviour is tested via integration tests instead.
 */
...
describe("AgeGateMachine.ts - Full Coverage", () => {
  ...
  describe("constants validation", () => {
    it("POLLING_CONFIG constants exist in code", () => {
      // Validates via behaviour in tests
